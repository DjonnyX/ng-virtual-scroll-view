...
/**
 * calculateVelocity
 * @link https://github.com/DjonnyX/ng-virtual-scroll-view/blob/16.x/projects/ng-virtual-scroll-view/src/lib/components/ng-scroll-view/utils/calculate-velocity.ts
