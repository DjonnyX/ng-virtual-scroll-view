 ...
 * @link https://github.com/DjonnyX/ng-virtual-scroll-view/blob/18.x/projects/ng-virtual-scroll-view/src/lib/components/ng-scroll-view/ng-scroll-view.component.ts
